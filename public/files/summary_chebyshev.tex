...
\]
and the transport-style density smoother $R_{DW}(a)=\frac{\lambda_{DW}}{2}a^\top E^\top L^+Ea$. In coefficient space, the constrained fit is the projection:
\[
